...
# The notification component needs a real, unique entrypoint in the header.
...
# Keep errors contextual across all explicit local-AI entrypoints, without
# selecting another provider or converting request cancellation into success.
...
# Wide tables scroll locally; document overflow is not hidden or clipped.
...
''')
print('Notification entrypoint and compact header, contextual local errors, mobile audit containment, and precise test targets connected.')
