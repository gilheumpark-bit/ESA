...
> 이 문서는 `ad95dbc` 시점의 역사 기록이다. graph v7, 고밀도 MCC 재실행, KEC 212.7.2 정확 계약은 [후속 수리 인수인계](2026-08-03-drawing-density-kec-212-7-2-repair.md)와 현재 [PROJECT_STATE](../../../PROJECT_STATE.md)를 따른다.
