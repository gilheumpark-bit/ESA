...
> 보존 대상: `690ad046dd7f77cb84d5517a5b197fa7d8663752:PROJECT_STATE.md`.
> 아래는 이전 기록이며 현재 상태가 아니다. 본문을 보존하고 상대 링크만 새 위치에 맞췄다.
> 현재 정본: [PROJECT_STATE](../../../PROJECT_STATE.md). 실증 이력: [검증 원장](../../VALIDATION_EVIDENCE.md).
...
위 커밋은 PR #71에서 직전 전체 CI를 통과한 **출발 기준선**이다. `main` 병합 완료를 뜻하지 않는다. 이 문서를 포함한 후속 변경은 단자 경로 복원, 완료 페이지 보존과 업무 보고서 수리이며, 정확한 변경 커밋과 통합 검사 결과는 PR #71의 해당 HEAD를 따른다. [2026-09-08 인수인계](2026-09-08-commercial-drawing-workflow.md)는 구현·로컬 검증·실도면 출시 검증의 경계를 구분한다.
...
- [문서 지도](../../README.md)
- [기능 배선 지도](../IMPLEMENTATION_MAP.md)
- [구조 결정 기록](../DECISIONS.md)
- [SLD V3 §1–15 추적표](../SLD_V3_TRACEABILITY.md)
- [기술부채 대장](../../TECHNICAL_DEBT.md)
- [최신 인수인계 — 8월 26일 개발 부채·문서 정본화](2026-08-26-zzz-development-debt-docs-sync.md)
- [과거 인수인계 색인](../HANDOFFS.md)
- [휴면 기능 대장](../../DORMANT_MANIFEST.md)
- [현실화 게이트](../../REALIZATION_PLAN.md)
- [경계 연속성 설계](../../superpowers/specs/2026-07-23-sld-region-continuity-integrated-recovery-design.md)
- [경계 연속성 구현 계획](../../superpowers/plans/2026-07-23-sld-region-continuity-integrated-recovery.md)
