...
> 문서 상태: 2026-07-21 설계 배경. 이후 SLD V3 전체 문서·페이지 간 연속성 구현이 추가됐으므로 현재 완료 상태는 [IMPLEMENTATION_MAP](../IMPLEMENTATION_MAP.md)과 [SLD V3 추적표](../SLD_V3_TRACEABILITY.md)를 우선합니다.
