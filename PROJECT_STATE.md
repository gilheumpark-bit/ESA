...
status: active
baselineBranch: main
codeBaselineCommit: f481d913ec5057ece7651875ed532c4c50e42f16
...
- 현재 제품 코드 기준선은 `f481d913ec5057ece7651875ed532c4c50e42f16`이다. 생성된 `.next/`, `test-results/`, 검증용 작업 JSON과 브라우저 임시 업로드는 Git에 포함하지 않았다.
