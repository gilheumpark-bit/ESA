...
const SECTIONS = [
  ...
  {
    title: '제3조 (사용자 책임)',
    body: '사용자는 ESA에서 얻은 정보를 반드시 독립적으로 검증할 책임이 있습니다. ESA의 출력물을 근거로 한 설계, 시공, 또는 의사결정의 최종 책임은 사용자에게 있습니다.',
  },
  {
    title: '제4조 (BYOK 정책)',
    body: 'ESVA는 BYOK(Bring Your Own Key) 방식을 지원합니다. 저장된 키 본문은 브라우저 IndexedDB에 AES-GCM으로 암호화되며, 복호화 키는 내보낼 수 없는 브라우저 CryptoKey로 관리됩니다. AI 요청 시 복호화된 키가 TLS로 ESVA 서버에 전달되어 선택한 제공자 요청에 사용될 수 있습니다. 키 폐기와 제공자 과금 관리는 사용자 책임입니다.',
  },
  {
    title: '제5조 (면책)',
  ...
  {
    title: '제6조 (지적재산권)',
    body: 'ESA의 소프트웨어, 디자인, 로고 및 콘텐츠의 지적재산권은 ESA에 귀속됩니다. 사용자가 생성한 계산 결과 및 영수증의 권리는 사용자에게 있습니다.',
  },
  {
    title: '제7조 (약관 변경)',
    body: '본 약관은 서비스 개선 및 법적 요구에 따라 변경될 수 있습니다. 변경 시 서비스 내 공지로 안내합니다.',
  },
];
