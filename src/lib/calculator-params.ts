...
export const CALCULATOR_PARAMS: Record<string, ExtendedParamDef[]> = {
  ...
  'unit-converter': [
    { name: 'value', type: 'number', unit: '', description: '변환할 값', defaultValue: 0.4 },
    { name: 'fromUnit', type: 'string', unit: '', description: '현재 단위', options: [
      { value: 'V', label: 'V' },
      { value: 'mV', label: 'mV' },
      { value: 'kV', label: 'kV' },
      { value: 'A', label: 'A' },
    ...
    { name: 'toUnit', type: 'string', unit: '', description: '바꿀 단위', options: [
      { value: 'V', label: 'V' },
      { value: 'mV', label: 'mV' },
      { value: 'kV', label: 'kV' },
      { value: 'A', label: 'A' },
...
export const CALCULATOR_NAMES: Record<string, { name: string; nameEn: string }> = {
  ...
  'unit-converter': { name: '전기 단위 환산', nameEn: 'Unit Converter' },
