...
const DECLARED_MISMATCHES = new Map([
  ...
  // 211.1~211.5(배선 공사방법) 해소 2026-07-27 — 232.2 공사의 종류 · 232.10 전선관시스템 ·
  // 232.11 합성수지관 · 232.12 금속관 · 232.41 케이블트레이 · 232.51 케이블 · 232.61 버스덕트
  ...
  // 현행 231.1 = 공통사항.
  ['231.1', '전선의 최소 굵기'],
  // 232.1~232.4(허용전류) 해소 2026-07-27 — 232.5 허용전류 · 232.5.2 결정 · 232.5.3 그룹
