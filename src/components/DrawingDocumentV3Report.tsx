...
export function DrawingDocumentV3Report({ document, selectedDisplayId, onSelectDisplayId, onCorrect, correctingDisplayId }: DrawingDocumentV3ReportProps) {
  ...
  const readSummary = summarizeDrawingReadState(document);
