...
$steps = @(
  @{ Name = 'Tracked repository hygiene'; Command = 'npm'; Arguments = @('run', 'gate:hygiene') },
  ...
  @{ Name = 'Production dependency audit'; Command = 'npm'; Arguments = @('run', 'gate:audit') },
  @{ Name = 'All dependency audit'; Command = 'npm'; Arguments = @('run', 'gate:audit:all') },
