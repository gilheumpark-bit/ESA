...
export const DRAWING_SPECS = [
...

  {
    ...
    texts: [
      ...
      { content: 'F-CV 4C 95sq 포설: 전선관 주위온도 30°C 집합회로 1회로', x: 190, y: 500 },
      { content: 'F-CV 4C 16sq 포설: 전선관 주위온도 30°C 집합회로 1회로', x: 190, y: 300 },
    ],
    /**
     * 검토층 정답 — **손으로 쓴다. 파서/판정 출력에서 파생하지 않는다.**
     * 두 판정 모두 표 판(edition)에 무관하게 참이고, 허용전류 계산에 필요한
     * 공사방법·주위온도·집합회로 수는 도면 문자열에 명시한다:
